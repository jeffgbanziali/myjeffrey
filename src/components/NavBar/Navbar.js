    ...
    return (
        <>
            <div className='z-10 flex flex-col items-center justify-center  xl:h-[120px] h-[90px] shadow-lg w-full'>
                <div className='bg-blue-900 xl:h-[50%] h-full w-full flex items-center p-2'>
                    <div className='flex items-center  w-full lg:w-1/4 p-2'>
                        ...
                        <div className='ml-4 h-8 w-20 p-2 xl:text-[14px] text-[12px] flex border border-red-500 justify-center items-center rounded-xl'>
                            <div className='w-2 h-2 rounded-full bg-orange-500 mr-1' />   <p className='italic text-white'>{user.role}</p>
                    ...
                    <>
                        <div className='bg-blue-300 w-full h-[600px]'>
                            <ul className="flex flex-col  item-center justify-center space-y-2 lg:flex-row lg:w-[800px] h-full lg:justify-around p-4">
                                ...
                                <button
                                    onClick={handleLogout}
                                    className="xl:w-24   w-24 xl:hidden flex  item-center justify-center bg-blue-500 text-white text-[8px] p-2 rounded-lg hover:bg-blue-600">
                                    SE DECONNECTER
                                </button>
                            </ul>
