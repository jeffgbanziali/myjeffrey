...
const EnterNote = () => {
    ...
    console.log("Mon cours", studentsList)

    return (
        <div className='top-0 left-0 w-full h-full bg-opacity-75 flex'>
            <div className="flex pb-10 flex-col justify-center w-[100%] rounded-xl h-[100%] shadow-lg transform transition-all ease-in-out duration-300 scale-100">
                <Navbar user={user} />
                <div className='w-full pt-10 h-full bg-opacity-75 flex justify-center items-center'>
